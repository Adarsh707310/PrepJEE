...
class LongContestResult extends StatefulWidget {
  ...
  LongContestResult(
      ...
      this.uid});
  @override
  _LongContestResultState createState() => _LongContestResultState();
}

class _LongContestResultState extends State<LongContestResult> {
  int attemtedQue = 0;
  int unattemtedQue = 0;
  int correctAns = 0;
  int totalQue = 25;
