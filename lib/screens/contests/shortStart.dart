...
import 'package:jeeapp/screens/contests/shortcontestresult.dart';
...
class ShortStart extends StatefulWidget {
  final String queBelongTo;
  ShortStart({this.queBelongTo});
  @override
  _ShortStartState createState() => _ShortStartState();
}

class _ShortStartState extends State<ShortStart> {
  List score = [0, 0, 0, 0, 0, 0, 0];
  List answerMarked = ['', '', '', '', '', '', ''];
  List qid = ['', '', '', '', '', '', ''];
  List pointScored = [0, 0, 0, 0, 0, 0, 0];
  ...
  void endContest() {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ShortContestResult(
                  score: score,
                        ...
                        children: <Widget>[
                          CircleAvatar(
                            child: IconButton(
                              ...
                              onPressed: () {
                                pageController.animateToPage(pageCahnged - 1,
