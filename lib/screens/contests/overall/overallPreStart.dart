...
import 'package:jeeapp/screens/contests/overall/overallStart.dart';
import 'package:jeeapp/shared/constants.dart';

class OverallPreStart extends StatefulWidget {
  ...
  @override
  _OverallPreStartState createState() => _OverallPreStartState();
}

class _OverallPreStartState extends State<OverallPreStart> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        ListTile(
                          ...
                          title: Text(
                            '7 question for Each Physics, Chemistry ans Mathematics',
